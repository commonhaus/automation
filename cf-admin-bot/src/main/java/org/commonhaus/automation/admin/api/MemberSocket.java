...
import org.commonhaus.automation.admin.api.Message.MessageDecoder;
import org.commonhaus.automation.admin.api.Message.MessageEncoder;
import org.commonhaus.automation.admin.api.Message.Type;
...
public class MemberSocket {
    ...
    public void onOpen(Session session) {
        ...
        if (!memberProfile.hasConnection()) {
            sendMessage(session, new Message(Type.ERROR, "Problem working with GitHub credentials."));
    ...
    public boolean sendMessage(Session session, Message message) {
        if (session.isOpen()) {
            try {
